...
|---|---|---|
| **Neutral AI tanks** ✅ | `entities.py`, `ai.py`, `gameplay.py`, `net_handlers.py`, `rendering/` | `is_neutral` flag on `Tank`; `TankAI` targets list; host-authoritative `neutral_sync` TCP event every 100 ms; grey/yellow sprite palette |
